...
@section('content')
    ...
    <div class="max-w-7xl mx-auto py-20 sm:px-6 lg:px-8 text-center">
        <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
            <span class="block">Selamat Datang di Aplikasi Kami</span>
        </h1>
        <p class="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Solusi terbaik untuk mengelola semua kebutuhan Anda dalam satu platform yang mudah digunakan.
        </p>
